                    ...
                    RowLayout {
                        ...
                        MouseArea { 
                            ...
                            Text { 
                                ...
                                property real _txPrev: parent.containsMouse ? window.s(-5) : wPrevMa.pulseOffset
                                 transform: Translate { x: _txPrev }
                        ...
                        MouseArea { 
                            ...
                            Text { 
                                anchors.centerIn: parent; text: ""; font.family: "Iosevka Nerd Font"; font.pixelSize: window.s(18)
                                color: parent.containsMouse ? window.textAccent : window.overlay1
                                property real _txNext: parent.containsMouse ? window.s(5) : wNextMa.pulseOffset
                                 transform: Translate { x: _txNext }
                                Behavior on transform { NumberAnimation { duration: 250; easing.type: Easing.OutBack } }
                            }
                        }
                    }
